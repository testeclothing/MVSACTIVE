...
const PartnerDeck: React.FC = () => {
  ...
  const renderSlide = () => {
    switch (currentSlide) {
      ...
      case 0:
        return (
          <div className="flex flex-col items-center justify-center h-full text-center px-6">
            <div className="mb-8 md:mb-12 h-16 md:h-24 w-auto flex items-center justify-center">
            ...
            <h1 className="font-display text-4xl md:text-7xl font-bold text-white mb-6 leading-tight md:leading-[0.9]">
      ...
      case 1:
        return (
          <div className="flex flex-col h-full justify-center px-6 max-w-5xl mx-auto w-full py-10 md:py-0">
             ...
             <div className="grid gap-4 overflow-y-auto max-h-[60vh] md:max-h-none pr-2">
                {[
                    ...
                    <div key={i} className="bg-[#111] p-5 md:p-6 rounded-lg border border-white/5 flex flex-col md:flex-row items-start gap-4">
      ...
      case 2:
        return (
          <div className="flex flex-col h-full pt-16 md:pt-20 px-4 md:px-6 max-w-6xl mx-auto w-full">
             ...
             <div className="flex-1 relative rounded-lg overflow-hidden border border-white/10 bg-[#050505] mb-24 md:mb-12 min-h-[300px]">
                <ComparisonSlider 
      ...
      case 4:
        return (
            <div className="flex flex-col h-full justify-center px-4 md:px-6 max-w-5xl mx-auto w-full text-center">
                <div className="mb-6 md:mb-8 shrink-0">
                    <h2 className="font-display text-2xl md:text-4xl text-white mb-2 md:mb-4">Resolution Authority</h2>
                ...
                <div 
                    ...
                    className="relative aspect-square md:aspect-video w-full bg-black rounded-lg border border-white/10 overflow-hidden cursor-move touch-none mb-10 md:mb-0"
                ...
                >
                    ...
                    {/* Controlos */}
                    <div className="absolute bottom-4 md:bottom-6 left-1/2 -translate-x-1/2 flex items-center gap-4 bg-black/90 backdrop-blur-md px-4 py-2 md:px-6 md:py-3 rounded-full border border-white/20 shadow-xl z-20 whitespace-nowrap">
      ...
      case 5:
        return (
            <div className="flex flex-col h-full justify-center px-4 md:px-6 max-w-6xl mx-auto w-full py-12 md:py-0">
                <div className="text-center mb-8 md:mb-12 shrink-0">
                    <span className="text-[9px] md:text-[10px] font-bold uppercase tracking-[0.2em] text-neon mb-2 md:mb-4 block">Forensic Verification</span>
                    <h2 className="font-display text-2xl md:text-4xl text-white">The Authenticity Protocol</h2>
                </div>
                
                {/* Grid Responsiva: 1 coluna no mobile, 2 no desktop */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 flex-1 md:flex-none overflow-y-auto md:overflow-visible">
                ...
                <div className="flex justify-center gap-8 md:gap-12 mt-8 text-center shrink-0 pb-20 md:pb-0">
      ...
      case 6:
        return (
            <div className="flex flex-col h-full justify-center px-6 max-w-5xl mx-auto w-full py-12 md:py-0">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 overflow-y-auto max-h-[50vh] md:max-h-none pr-2">
                    {[
                        ...
                        <div key={i} className="bg-[#111] p-6 rounded-lg border border-white/5 hover:border-neon/30 transition-colors group">
                            <item.icon className="w-6 h-6 md:w-8 md:h-8 text-gray-600 group-hover:text-neon mb-3 md:mb-4 transition-colors" />
                ...
                <div className="mt-8 md:mt-16 text-center pb-24 md:pb-0">
  ...
  return (
    // Usa h-[100dvh] para garantir que ocupa o ecrã todo no mobile
    <div className="bg-black h-[100dvh] text-white overflow-hidden relative font-sans flex flex-col">
        
        {/* Slides Area - Flex 1 para ocupar o espaço disponível */}
